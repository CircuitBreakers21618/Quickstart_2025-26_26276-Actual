...
public class testAuto extends OpMode {
    ...
    private final Pose startPose = new Pose(26, 129, Math.toRadians(145)); // Start Pose of our robot.
    private final Pose scorePose = new Pose(60, 85, Math.toRadians(135));
    private final Pose pickup1start = new Pose(50, 85, Math.toRadians(180));
    private final Pose pickup2start = new Pose(50, 60, Math.toRadians(180));
    private final Pose endPose = new Pose(50, 65, Math.toRadians(180));
    private final Pose pickup1Pose = new Pose(30, 85, Math.toRadians(180)); // Highest (First Set) of Artifacts from the Spike Mark.
